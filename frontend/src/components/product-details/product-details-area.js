        ...
        <div className="row">
          ...
          <div className="col-xl-5 col-lg-6">
            <div className="product__details-wrapper">
              ...
              Connect with us and enjoy exclusive offers, including free shipping on all qualifying orders! Stay updated on the latest deals, discounts, and special promotions, all designed to bring you everyday low prices on a wide selection of products.
              </p>
              ...
              <ProductDetailsCategories category={product.category} />
              {/* ProductDetailsCategories */}
